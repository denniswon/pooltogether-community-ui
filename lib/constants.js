...
import CompoundPrizePoolProxyLocalhost from '@pooltogether/pooltogether-contracts/deployments/localhost/CompoundPrizePoolProxyFactory.json'
...
import StakePrizePoolProxyLocalhost from '@pooltogether/pooltogether-contracts/deployments/localhost/StakePrizePoolProxyFactory.json'
...
export const CONTRACT_ADDRESSES = {
  ...
  31337: {
    COMPOUND_PRIZE_POOL_PROXY: CompoundPrizePoolProxyLocalhost.address,
    STAKE_PRIZE_POOL_PROXY: StakePrizePoolProxyLocalhost.address,
    RNG_SERVICE: {
      blockhash: '',
      chainlink: ''
    }
